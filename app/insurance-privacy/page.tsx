    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="bg-white p-8 rounded-xl shadow-md mb-10">
        ...
        <div className="prose max-w-none">
          ...
          <p>
            This Insurance Privacy Policy explains how Gardian Real Estate
            ("we," "our," or "us") collects, uses, discloses, and safeguards
            your personal information specifically in relation to insurance
            services we may offer or recommend. This policy should be read in
            conjunction with our general Privacy Policy.
          </p>
          ...
          <p>
            When you express interest in or apply for insurance services through
            us, we may collect additional personal information, including:
          </p>
          ...
          <h2 className="text-2xl font-semibold text-teal-600 mt-8 mb-4">
            How We Use Your Insurance Information
          </h2>
          <p>
            We may use the information we collect for insurance purposes to:
          </p>
          <ul className="list-disc pl-6 mb-6">
          ...
          <p>
            We will obtain your explicit consent before collecting, using, or
            disclosing sensitive information for insurance purposes. You have
            the right to withdraw your consent at any time, though this may
            affect our ability to provide certain services.
          </p>

          <h2 className="text-2xl font-semibold text-teal-600 mt-8 mb-4">
            Security of Your Insurance Information
          </h2>
          <p>
            We take additional precautions to protect sensitive insurance
          ...
          <h2 className="text-2xl font-semibold text-teal-600 mt-8 mb-4">
            Retention of Insurance Information
          </h2>
          <p>
            We retain insurance-related information for as long as necessary to
            fulfill the purposes outlined in this policy, unless a longer
            retention period is required or permitted by law. This typically
            includes the duration of your insurance policy plus any applicable
          ...
          <p>
            In addition to the rights outlined in our general Privacy Policy,
            you have specific rights regarding your insurance information:
          </p>
          <ul className="list-disc pl-6 mb-6">
            <li>
              The right to know what insurance information we hold about you
            </li>
            <li>The right to correct inaccurate insurance information</li>
            <li>
              The right to restrict processing of your insurance information in
              certain circumstances
            </li>
            <li>
              The right to object to automated decision-making related to
          ...
          <p>
            We may update our Insurance Privacy Policy from time to time. We
          ...
          <p>
            If you have any questions about this Insurance Privacy Policy,
