          ...
          <div className="bg-gradient-to-r from-teal-600 to-teal-700 text-white rounded-xl p-4 mb-6 shadow-lg">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-semibold">{property.agents[0].name}</p>
                  <p className="text-sm text-white/80">{property.agents[0].title || 'Property Agent'}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                {property.agents[0].mobile && (
                  <a 
                    href={`tel:${property.agents[0].mobile}`}
