...
export default async function HomePage() {
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section className="relative bg-gradient-to-br from-green-25 via-green-50 to-emerald-50 py-16 lg:py-24 overflow-hidden">
        {/* Ultra Light Animated Background Elements */}
        <div className="absolute inset-0 bg-gradient-to-tr from-green-50/30 via-green-25/20 to-emerald-25/25 animate-pulse"></div>
        <div className="absolute inset-0 bg-gradient-to-bl from-green-25/15 via-transparent to-emerald-50/20 animate-pulse delay-1000"></div>
        
        {/* Floating Animated Orbs - Ultra Light Green */}
        <div className="absolute top-0 left-0 w-full h-full">
          <div className="absolute top-20 left-10 w-80 h-80 bg-green-100/15 rounded-full blur-3xl animate-bounce delay-300" style={{animationDuration: '6s'}}></div>
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-emerald-100/20 rounded-full blur-3xl animate-bounce delay-700" style={{animationDuration: '8s'}}></div>
          <div className="absolute top-1/3 right-1/4 w-64 h-64 bg-green-200/10 rounded-full blur-3xl animate-bounce delay-1000" style={{animationDuration: '7s'}}></div>
          <div className="absolute bottom-1/3 left-1/4 w-72 h-72 bg-emerald-200/15 rounded-full blur-3xl animate-bounce delay-500" style={{animationDuration: '9s'}}></div>
        </div>
        
        {/* Ultra Light Moving Gradient Overlay */}
        <div className="absolute inset-0 opacity-25">
          <div className="absolute inset-0 bg-gradient-to-r from-green-100/20 to-emerald-100/20 animate-pulse delay-200"></div>
          <div className="absolute inset-0 bg-gradient-to-l from-emerald-200/15 to-green-50/20 animate-pulse delay-1500"></div>
        </div>
        
        <div className="container mx-auto px-4 text-center relative z-10">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 lg:mb-8 text-gray-800 leading-tight drop-shadow-sm">
            We can help you buy, sell and manage your property
          </h1>
          <p className="text-lg sm:text-xl lg:text-2xl text-gray-700 mb-8 lg:mb-10 max-w-4xl mx-auto leading-relaxed px-4 font-medium drop-shadow-sm">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 lg:gap-6 max-w-5xl mx-auto">
            <Link href="/buy" className="bg-white/95 backdrop-blur-sm p-5 lg:p-6 rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-3 hover:scale-105 group border border-white/20">
              <div className="text-center">
                <div className="w-12 h-12 bg-gradient-to-br from-primary-500 to-primary-600 rounded-2xl flex items-center justify-center mx-auto mb-3 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                  </svg>
                </div>
                <span className="text-sm font-bold text-gray-800 group-hover:text-primary-600 transition-colors">Buying</span>
              </div>
            </Link>
            <Link href="/sell" className="bg-white/95 backdrop-blur-sm p-5 lg:p-6 rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-3 hover:scale-105 group border border-white/20">
              <div className="text-center">
                <div className="w-12 h-12 bg-gradient-to-br from-emerald-500 to-green-600 rounded-2xl flex items-center justify-center mx-auto mb-3 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                  </svg>
                </div>
                <span className="text-sm font-bold text-gray-800 group-hover:text-emerald-600 transition-colors">Selling</span>
              </div>
            </Link>
            <Link href="/rent" className="bg-white/95 backdrop-blur-sm p-5 lg:p-6 rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-3 hover:scale-105 group border border-white/20">
              <div className="text-center">
                <div className="w-12 h-12 bg-gradient-to-br from-sky-500 to-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-3 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                  </svg>
                </div>
                <span className="text-sm font-bold text-gray-800 group-hover:text-sky-600 transition-colors">Renting</span>
              </div>
            </Link>
            <Link href="/sold" className="bg-white/95 backdrop-blur-sm p-5 lg:p-6 rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-3 hover:scale-105 group border border-white/20">
              <div className="text-center">
                <div className="w-12 h-12 bg-gradient-to-br from-amber-500 to-orange-600 rounded-2xl flex items-center justify-center mx-auto mb-3 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <span className="text-sm font-bold text-gray-800 group-hover:text-amber-600 transition-colors">Auctions</span>
              </div>
            </Link>
            <Link href="/commercial" className="bg-white/95 backdrop-blur-sm p-5 lg:p-6 rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-3 hover:scale-105 group border border-white/20">
              <div className="text-center">
                <div className="w-12 h-12 bg-gradient-to-br from-violet-500 to-purple-600 rounded-2xl flex items-center justify-center mx-auto mb-3 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                  </svg>
                </div>
                <span className="text-sm font-bold text-gray-800 group-hover:text-violet-600 transition-colors">Commercial</span>
              </div>
            </Link>
          </div>
        </div>
                    ...
                    {property?.images && property.images.length > 0 ? (
                      ...
                      <div className="h-64 bg-gradient-to-br from-primary-50 to-primary-100 flex items-center justify-center">
                        <div className="text-center">
                          ...
                          <span className="text-primary-400 font-medium text-sm">Residential Property</span>
                        </div>
                      </div>
                    )}
                    <div className="p-7">
                      <h3 className="text-xl font-bold mb-3 text-gray-800 line-clamp-2 group-hover:text-primary-700 transition-colors">
                        {(() => {
                          // Clean up property title to remove duplicates and agency names
                          const heading = property?.heading || property?.address?.displayAddress || 'Residential Property';
                          const cleanHeading = heading
                            ...
                            .replace(/\s+/g, ' ')
                            .trim();
                          return cleanHeading || property?.address?.displayAddress || 'Residential Property';
                        })()}
                      </h3>
                      {property?.price && (
                      ...
                      <Link 
                        ...
                        className="inline-flex items-center bg-primary-600 text-white px-6 py-3 rounded-xl hover:bg-primary-700 transition-all duration-300 font-semibold shadow-md hover:shadow-lg transform hover:scale-105 w-full justify-center group-hover:bg-primary-700"
                      >
                        View This Home
      ...
      <section className="py-16 bg-gradient-to-br from-primary-25 via-primary-50 to-emerald-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-white rounded-3xl shadow-2xl p-8 lg:p-12 border border-primary-100">
              <div className="flex items-center justify-center mb-6">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-primary-600 font-semibold">Powered by HomeLoad</p>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link 
                  href="/finance" 
                  className="inline-flex items-center bg-primary-600 text-white px-8 py-4 rounded-xl hover:bg-primary-700 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 group"
                >
                ...
                <Link 
                  href="/insurance" 
                  className="inline-flex items-center bg-white text-primary-600 border-2 border-primary-600 px-8 py-4 rounded-xl hover:bg-primary-50 transition-all duration-300 font-semibold group"
                >
                  Get Insurance Quote
                  <svg className="w-5 h-5 ml-2 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
