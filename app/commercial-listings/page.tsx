...
export default async function CommercialListingsPage({ searchParams }: PageProps) {
  ...
  try {
    ...
    console.log(`✅ Commercial listings: ${totalCount} total properties, showing ${listings.length} on page ${page}/${totalPages}`);
  } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm border-b border-gray-200">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <Link href="/commercial" className="flex items-center text-teal-600 hover:text-teal-700">
            ...
            <nav className="text-sm text-gray-500">
              ...
              <Link href="/commercial" className="hover:text-teal-600">Commercial Services</Link>
              <span className="mx-2">/</span>
      ...
      <div className="container mx-auto px-4 py-8">
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-4 text-gray-800">Commercial Property Listings</h1>
          <p className="text-gray-600 mb-4">
            Browse our current portfolio of commercial properties available for sale and lease in Mackay and surrounding areas.
          </p>
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex space-x-2">
              <Link
                href="/commercial-listings?disposalMethod=forSale"
              ...
              <Link
                href="/commercial-listings?disposalMethod=forRent"
                className={`px-4 py-2 rounded text-sm font-medium ${
