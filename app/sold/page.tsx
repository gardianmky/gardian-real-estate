            ...
            <div className="text-center py-12 sm:py-16">
              <div className="max-w-md mx-auto bg-white rounded-2xl p-6 sm:p-8 shadow-lg border border-gray-100">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                  <Link href="/for-sale" className="bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors font-medium text-center">
                    View Properties For Sale
                  </Link>
                  <Link href="/for-rent" className="bg-white text-teal-600 border-2 border-teal-600 px-6 py-3 rounded-lg hover:bg-teal-50 transition-colors font-medium text-center">
