              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={index} className="flex">
                    <div className="flex-shrink-0 w-2 h-2 bg-primary-600 rounded-full mt-3 mr-4"></div>
                    <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-primary-600 text-white rounded-2xl p-8 shadow-lg">
                <div className="text-center">
                  ...
                  <div className="text-primary-100 mb-6">of rental income + GST</div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div>
              ...
              <p className="text-primary-100 mt-4 mb-2">After Hours Property Management</p>
