    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="bg-white p-8 rounded-xl shadow-md mb-10">
        ...
        <div className="prose max-w-none">
          ...
          <p>
            Welcome to Gardian Real Estate. These Terms of Service ("Terms")
            govern your use of our website and services. By accessing or using
            our website and services, you agree to be bound by these Terms. If
          ...
          <ul className="list-disc pl-6 mb-6">
            <li>
              <strong>"Website"</strong> refers to Gardian Real Estate's
              website.
            </li>
            <li>
              <strong>"Services"</strong> refers to the real estate services
              provided by Gardian Real Estate.
            </li>
            <li>
            ...
            <li>
              <strong>"We," "Us," and "Our"</strong> refer to Gardian Real
              Estate.
            </li>
          </ul>
          ...
          <ul className="list-disc pl-6 mb-6">
            ...
            <li>
              Not use our Website or Services in any way that violates any
              applicable federal, state, local, or international law or
              regulation.
            </li>
            <li>
              Not use our Website or Services to transmit or send unsolicited
              commercial communications.
            </li>
            <li>
              Not attempt to gain unauthorized access to, interfere with,
              damage, or disrupt any parts of our Website or Services.
            </li>
            <li>
              Not use our Website or Services for any purpose that is unlawful
          ...
          <p>
            ...
            arrangement thereof) are owned by Gardian Real Estate, its
            licensors, or other providers of such material and are protected by
            Australian and international copyright, trademark, patent, trade
            secret, and other intellectual property or proprietary rights laws.
          </p>

          <p>
            These Terms grant you a limited, non-exclusive, non-transferable,
            revocable license to access and use our Website and Services for
            your personal, non-commercial use. You may not reproduce,
          ...
          <p>
            ...
            safeguarding the password that you use to access our Website and
          ...
          <p>
            In no event shall Gardian Real Estate, its directors, employees,
          ...
          <p>
            You agree to defend, indemnify, and hold harmless Gardian Real
            Estate, its directors, employees, partners, agents, suppliers, and
          ...
          <p>
            ...
            the laws of Queensland, Australia, without regard to its conflict of
            law provisions.
          </p>
          <p>
          ...
          <p>
            By continuing to access or use our Website or Services after any
