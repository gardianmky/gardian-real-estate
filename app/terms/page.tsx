    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="bg-white p-8 rounded-xl shadow-md mb-10">
        ...
        <div className="prose max-w-none">
          ...
          <h2 className="text-2xl font-semibold text-teal-600 mt-8 mb-4">2. Definitions</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-teal-600 mt-8 mb-4">3. Use of Our Website and Services</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-teal-600 mt-8 mb-4">4. Intellectual Property</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-teal-600 mt-8 mb-4">5. User Accounts</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-teal-600 mt-8 mb-4">6. Limitation of Liability</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-teal-600 mt-8 mb-4">7. Indemnification</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-teal-600 mt-8 mb-4">8. Governing Law</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-teal-600 mt-8 mb-4">9. Changes to These Terms</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-teal-600 mt-8 mb-4">10. Contact Us</h2>
          <p>
