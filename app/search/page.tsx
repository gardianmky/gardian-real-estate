...
export default async function SearchPage({
  ...
  const propertyType = typeof resolvedSearchParams?.propertyType === 'string' 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li>
                    <a href="/insurance-privacy" className="text-gray-500 hover:text-teal-600 transition-colors">
                      Insurance Privacy Policy
                    </a>
                  </li>
                  <li>
                    <a href="/privacy" className="text-gray-500 hover:text-teal-600 transition-colors">
                      Privacy Policy
                    </a>
                  </li>
                  <li>
                    <a href="/complaints" className="text-gray-500 hover:text-teal-600 transition-colors">
                      Complaints
                    </a>
                  </li>
                  <li>
                    <a href="/compliance" className="text-gray-500 hover:text-teal-600 transition-colors">
                      Compliance
                    </a>
                  </li>
                </ul>
