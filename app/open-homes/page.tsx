...
export default async function OpenHomesPage({ searchParams }: PageProps) {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mb-4">
            View properties with scheduled open home inspections in Mackay and
            surrounding areas. Book your inspection today!
          </p>
            ...
            <div className="text-sm text-gray-600">
              {totalCount > 0 ? (
                <>
                  ...
                  open {totalCount === 1 ? "home" : "homes"} scheduled
                  {totalPages > 1 && (
                    <span className="ml-2">
            ...
            <div className="text-center py-16">
              <div className="max-w-md mx-auto">
                ...
                <p className="text-gray-600 mb-6">
                  There are currently no open home inspections scheduled. Check
                  back soon or browse our available properties.
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h2 className="text-2xl font-bold mb-4 text-gray-800">
                About Open Home Inspections
              </h2>
              <p className="text-gray-600 mb-4">
                Open home inspections allow you to view properties at scheduled
                times without needing to book a private appointment. It's a
                great way to get a feel for the property and ask questions
            ...
            <div>
              <h3 className="text-xl font-bold mb-4 text-gray-800">
                Need a Private Inspection?
              </h3>
              <p className="text-gray-600 mb-6">
                Can't make it to an open home? We can arrange a private
