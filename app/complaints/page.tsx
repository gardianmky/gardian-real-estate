      ...
      <div className="bg-white p-8 rounded-xl shadow-md mb-10">
        ...
        <div className="prose max-w-none mb-8">
          <p className="text-gray-600 mb-6">
            At Gardian Real Estate, we are committed to providing exceptional
            service to all our clients. However, we recognize that sometimes
            things may not go as planned. If you have a concern or complaint
            about our services, we want to hear from you so we can address the
            issue and improve our service.
          </p>
          ...
          <div className="space-y-6 mb-8">
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-100">
              ...
              <p className="text-gray-700">
                In the first instance, please discuss your concerns with the
                staff member you have been dealing with. They will try to
            ...
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-100">
              ...
              <p className="text-gray-700">
                If you are not satisfied with the response, or if you prefer not
                to discuss the matter with the staff member involved, please
                contact our Office Manager at (07) 4957 7424 or email
            ...
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-100">
              ...
              <p className="text-gray-700">
                If your complaint cannot be resolved informally, we invite you
                to submit a formal complaint using the form below. We will
            ...
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-100">
              ...
              <p className="text-gray-700">
                We will investigate your complaint thoroughly and aim to provide
                a full response within 14 days. If more time is needed, we will
            ...
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-100">
              ...
              <p className="text-gray-700">
                Once we have completed our investigation, we will contact you
                with our findings and proposed resolution.
              </p>
            </div>
          </div>
          ...
          <p>
            ...
            may contact the following external bodies:
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {formStatus === "success" && (
              <div className="p-4 bg-green-50 text-green-700 rounded-md border border-green-200">
                Thank you for your complaint submission. We take all feedback
                seriously and will respond to you within 2 business days.
              </div>
            )}
            ...
            {formStatus === "error" && (
              <div className="p-4 bg-red-50 text-red-700 rounded-md border border-red-200">
                ...
                later or contact us directly at (07) 4957 7424.
              </div>
            )}
          </form>
        </div>
