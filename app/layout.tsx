          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
              ...
              <div className="col-span-1 md:col-span-2">
                <div className="mb-8">
                  <img src="/images/gardian-logo.webp" alt="Gardian Real Estate - Mackay's Best Real Estate" className="h-20 w-auto" />
                </div>
                ...
                <div className="flex space-x-4">
                  {/* LinkedIn */}
                  <a href="https://www.linkedin.com/in/showcase/gardian-real-estate" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-primary-600 transition-colors" aria-label="Follow us on LinkedIn">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z" />
                    </svg>
                  </a>
                  {/* YouTube */}
                  <a href="https://www.youtube.com/channel/UCfC4NysAKeLCb5uldUcoN-w" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-primary-600 transition-colors" aria-label="Subscribe to our YouTube channel">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z" />
                    </svg>
                  </a>
                  {/* Instagram */}
                  <a href="https://www.instagram.com/gardianmackay" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-primary-600 transition-colors" aria-label="Follow us on Instagram">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {/* Facebook */}
                  <a href="https://www.facebook.com/gardiangroup" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-primary-600 transition-colors" aria-label="Like us on Facebook">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-primary-600 mt-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                    <div>
                      <p className="text-gray-600 text-sm">For all enquiries and after hours:</p>
                      <a href="tel:0749577424" className="text-gray-800 hover:text-primary-600 transition-colors font-medium">07 4957 7424</a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-gray-600 text-sm">After hours property management:</p>
                      <a href="tel:0407440222" className="text-gray-800 hover:text-primary-600 transition-colors font-medium">0407 440 222</a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-gray-800">94 Victoria Street<br />Mackay QLD 4740</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <a href="mailto:info@gardianrealestate.com.au" className="text-gray-800 hover:text-primary-600 transition-colors">Send us an email</a>
                    </div>
                  </div>
                </div>
              </div>
