    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto bg-white rounded-2xl shadow-lg p-8">
          ...
          <h1 className="text-2xl font-bold text-gray-800 mb-4">Agent Profile Unavailable</h1>
          <p className="text-gray-600 mb-4">
            We're currently experiencing technical difficulties with our agent directory. Our team is working to resolve this issue.
          </p>
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6">
            <p className="text-sm text-amber-800">
              <strong>Note:</strong> Agent profiles are temporarily unavailable due to API maintenance. Please contact us directly for agent information.
            </p>
          </div>
